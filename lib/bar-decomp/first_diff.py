...
def firstDiffMain():
    ...
    parser.add_argument(
        "-v", "--version", help="Which version should be processed", default="us.rev1"
    )
    parser.add_argument(
    ...
    BUILTROM = Path(buildFolder / "beetleadventurerac.us.z64")
    BUILTMAP = buildFolder / "beetleadventurerac.us.map"
